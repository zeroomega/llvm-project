...
function(llvm_ExternalProject_Add name source_dir)
  message(NOTICE "")
  message(NOTICE "llvm_ExternalProject_Add called on ${name} ${source_dir} AND ${ARGN}")
  message(NOTICE "")
  ...
  message(NOTICE "")
  message(NOTICE "ExternalProject_Add called on ${name}")
  message(NOTICE "ExternalProject_Add DEPENDS ${ARG_DEPENDS}")
  message(NOTICE "ExternalProject_Add PREFIX ${CMAKE_BINARY_DIR}/projects/${name}")
  message(NOTICE "ExternalProject_Add SOURCE_DIR ${source_dir}")
  message(NOTICE "ExternalProject_Add STAMP_DIR ${STAMP_DIR}")
  message(NOTICE "ExternalProject_Add BINARY_DIR ${BINARY_DIR}")
  message(NOTICE "ExternalProject_Add exclude ${exclude}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS ${${nameCanon}_CMAKE_ARGS}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS --no-warn-unused-cli")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS ${compiler_args}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS ${verbose}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS sysroot_arg ${sysroot_arg}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_BINARY_DIR=${PROJECT_BINARY_DIR}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_CONFIG_PATH=${llvm_config_path}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_ENABLE_WERROR=${LLVM_ENABLE_WERROR}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_HOST_TRIPLE=${LLVM_HOST_TRIPLE}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_HAVE_LINK_VERSION_SCRIPT=${LLVM_HAVE_LINK_VERSION_SCRIPT}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_USE_RELATIVE_PATHS_IN_DEBUG_INFO=${LLVM_USE_RELATIVE_PATHS_IN_DEBUG_INFO}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_USE_RELATIVE_PATHS_IN_FILES=${LLVM_USE_RELATIVE_PATHS_IN_FILES}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_LIT_ARGS=${LLVM_LIT_ARGS}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DLLVM_SOURCE_PREFIX=${LLVM_SOURCE_PREFIX}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DPACKAGE_VERSION=${PACKAGE_VERSION}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DCMAKE_MAKE_PROGRAM=${CMAKE_MAKE_PROGRAM}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS -DCMAKE_EXPORT_COMPILE_COMMANDS=1")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS cmake_args ${cmake_args}")
  message(NOTICE "ExternalProject_Add CMAKE_ARGS PASSTHROUGH_VARIABLES ${PASSTHROUGH_VARIABLES}")
  message(NOTICE "")
